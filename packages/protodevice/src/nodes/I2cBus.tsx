...
const I2cBus = ({ node = {}, nodeData = {}, children, color }: any) => {
    ...
    return (
        <Node node={node} isPreview={!node.id} title='i2c Bus' color={color} id={node.id} skipCustom={true} output={{label: 'SDA Pin', field: 'value', type: 'output', labelColor: useTheme("titleColor")}}>
