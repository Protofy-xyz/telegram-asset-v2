...
const UARTBus = ({ node = {}, nodeData = {}, children, color }: any) => {
    ...
    return (
        <Node node={node} isPreview={!node.id} title='UART Bus' color={color} id={node.id} skipCustom={true} output={{label: 'TX Pin', field: 'value', type: 'output', labelColor: useTheme("titleColor")}}>
